...
Label(srednji_okvir, text="Prilozi:", bg="Green", fg="White").pack(side=TOP)
...
obim = IntVar()
placanje = IntVar()
Label(srednji_okvir, text="Obim:", bg="Green", fg="White").pack(side=TOP)
...
Label(srednji_okvir, text="Nacin placanja:", bg="Green", fg="White").pack(side=TOP)
